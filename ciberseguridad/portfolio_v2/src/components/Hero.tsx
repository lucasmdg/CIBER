...
const CyberAsset = dynamic(() => import("./CyberAsset"), { ssr: false });
  ...
  return (
    ...
    >
      <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center w-full">
        <div className="z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-accent-dim border border-accent/20 rounded-full text-xs font-mono text-accent tracking-wider mb-6">
        ...
        <div className="relative h-[450px] lg:h-[550px] xl:h-[600px] -z-10 lg:z-0">
          <CyberAsset />
        </div>
      </div>
