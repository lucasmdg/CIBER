          ...
          <div className="flex-1 max-w-2xl lg:order-2">
            ...
            >
              <a
                ...
                className="group relative inline-flex items-center gap-2 px-5 py-2.5 text-xs font-mono tracking-wider text-white rounded-lg overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-accent/20"
              >
      ...
      >
        ...
        <div className="w-px h-8 overflow-hidden rounded-full" style={{ background: "rgba(255,255,255,0.04)" }}>
          <motion.div
            ...
            style={{ background: "linear-gradient(to bottom, #58a6ff, transparent)" }}
            animate={{ y: ["-100%", "200%"] }}
